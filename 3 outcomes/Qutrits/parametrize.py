...
# to parametrize projectors we have to pass 108 parameters: 81 for U and 27 for the phase transition probabilities
def proj_pmt(params):
    ...
    trans_prob = jnp.reshape(jnp.abs(params[-27:]), (3, 9))
    ...
    return jnp.stack([Pi_0, Pi_1, Pi_2])
...
# states: 81 parameters, projectors: 108 params
...
def params_to_prob(params):
    ...
    Pi_A = proj_pmt(params[243:351])
    Pi_B = proj_pmt(params[351:459])
    Pi_C = proj_pmt(params[459:])

...
def proj_pmt(params):
    ...
    trans_prob = jnp.reshape(jnp.abs(params[-12:]), (3,4)) # 3 outcomes!
...
def params_to_prob(params):
    ...
    Pi_A = proj_pmt(params[48:76]) # now I need 16 parameters for U, 12 for the transition probabilities
    Pi_B = proj_pmt(params[76:104])
    Pi_C = proj_pmt(params[104:])

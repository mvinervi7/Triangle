...
# Load data
all_coordinates_lin = np.loadtxt("quantum_distance_sqrt.csv",delimiter=',',skiprows=1)
...
plt.savefig("./quantum_sqrt_symmetric_subspace_map_card_"+str(card)+".png",bbox_inches='tight')
